  ...
  return (
    <main className="min-h-screen px-12 py-6">
      <div className="max-w-4xl mx-auto bg-white rounded-[32px] p-8 border-[3px] border-black 
        ...
        <h1 className="text-4xl font-bold mb-12">About SolSpace AI</h1>

        <div className="space-y-12">
          {/* Introduction */}
          <section>
            <h2 className="text-2xl font-bold mb-4">What is SolSpace AI?</h2>
            <p className="text-gray-600 leading-relaxed">
              SolSpace AI is a place where anyone can create amazing artwork using AI. 
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    ...
                    to unlock special features with $SSAI tokens.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    $SSAI token holders will unlock powerful AI features:
                  </p>
                  ...
                  <p className="mt-3 text-sm text-gray-500">
                    Note: These advanced features will be exclusive to $SSAI holders
                  </p>
                </div>
              </div>
            </div>
          ...
          <section>
            ...
            <div className="bg-white rounded-[24px] p-6 border-[3px] border-black 
              ...
              <p className="text-gray-600 mb-4">
                We're launching AI agents for $SSAI token holders that will unlock:
              </p>
              ...
              <p className="mt-4 text-sm text-gray-500">
                These features will be exclusive to $SSAI token holders - stay tuned 
          ...
          <section className="mb-16">
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              big AI project, SolSpace AI gives you all the tools you need in one place. Our 
